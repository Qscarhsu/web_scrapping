...
for i in range(1,11):
    ...
    try:
        WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.CSS_SELECTOR, "a.file_ext.file_pdf")))

        datas = driver.find_elements(By.CSS_SELECTOR, "a.file_ext.file_pdf")
...
for url_ in list:
    ...
    os.system(f"curl {url_} -o 大考中心題庫(pdf)/test{n}.pdf")
